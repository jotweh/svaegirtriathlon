...
// check modules
$showRightColumn  = $this->countModules('position-3') || $this->countModules('position-8'); // or $this->countModules('position-6');
      ...
      <?php endif; ?>
        <div class="logoheader">
          <div class="content">
          	...
          	<div class="social">
          		<a href="http://www.facebook.com/SvAegirTriathlon" title="Besuche uns bei Facebook"><img width="40" src="/triathlon/images/facebook_icon.png" alt="facebook" /></a>
          	</div>
		  </div>
		...
		<!-- ul skiplinks content removed -->
          <!-- h2 unseen nav view search removed -->
          <!-- h3 unseen beez5 navigation removed -->
          <jdoc:include type="modules" name="position-1" />
          
          <div id="line">
          <div id="fontsize"></div>
          <!-- h3 unseen beez5 search removed -->
          <jdoc:include type="modules" name="position-0" />
          </div> <!-- end line -->
    <!-- div id="header-image" removed  -->
    <?php if (!$templateparams->get('html5', 0)): ?>
      </div><!-- end header -->
    <?php else: ?>
      </header><!-- end header -->
  ...
  <div id="back" class="content">
    ...
    <div id="<?php echo $showRightColumn ? 'contentarea2' : 'contentarea'; ?>">
        ...
        <?php if ($showRightColumn) : ?>
        	<!-- h2 unseen TPL_BEEZ5_ADDITIONAL_INFORMATION removed -->
