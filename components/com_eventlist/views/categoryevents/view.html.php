...
class EventListViewCategoryevents extends JView
{
	...
	function display( $tpl=null )
	{
		...
		if ($task == 'archive') {
			$pathway->addItem( JText::_( 'COM_EVENTLIST_ARCHIVE' ).' - '.$category->catname, JRoute::_('index.php?option='.$option.'&view=categoryevents&task=archive&id='.$category->slug));
