<?php
// $HeadURL: https://joomgallery.org/svn/joomgallery/JG-2.0/Module/JoomCategories/trunk/tmpl/default.php $
// $Id: default.php 3568 2012-01-20 14:50:47Z erftralle $
/**
...
<?php if(!$jg_installed) : ?>
  <p>
<?php   echo JText::_('MOD_JOOMCAT_JOOMGALLERY_NOT_INSTALLED_LBL'); ?>
  </p>
<?php elseif($cat_rows == null || $dberror != "") : ?>
  <p>
<?php   echo $dberror; ?>
  </p>
<?php else :
