...
<script type="text/javascript">
		...
		function submitbutton( pressbutton ) {
			...
			if ( title.length==0 ) {
    			...
    			alert("<?php echo JText::_( 'COM_EVENTLIST_TIME_WRONG', true ); ?>");
    			form.times.focus();
    			return false;
			} else if ( validator.validate(form.endtimes) === false ) {
  				alert("<?php echo JText::_( 'COM_EVENTLIST_ENDTIME_WRONG', true ); ?>");
  				form.endtimes.focus();
  				return false;
    	...
    	<fieldset class="el_fldst_details">
          ...
          <div class="el_venue floattext">
              ...
              <div class='el_buttons floattext'>
                	...
                	<button type="button" onclick="elSelectVenue(0,'<?php echo JText::_('COM_EVENTLIST_NO_VENUE'); ?>');"><?php  echo JText::_('COM_EVENTLIST_NO_VENUE'); ?></button>
                  <?php if ( $this->delloclink == 1 && !$this->row->id ) : //show location submission link ?>
              		<button type="button" onclick="submitbutton('addvenue');"><?php echo JText::_( 'COM_EVENTLIST_DELIVER_NEW_VENUE' ); ?></button>
                	<?php endif; ?>
    	...
    	<fieldset class="el_fldst_recurrence">
          ...
          <div class="recurrence_output floattext">
              ...
              <div id="counter_row" style="display:none;">
                  <label for="recurrence_counter"><?php echo JText::_( 'COM_EVENTLIST_RECURRENCECOUNTER' ); ?>:</label>
                  <div class="el_date>"><?php echo JHTML::_('calendar', ($this->row->recurrence_counter <> 0000-00-00) ? $this->row->recurrence_counter : JText::_( 'COM_EVENTLIST_UNLIMITED' ), "recurrence_counter", "recurrence_counter"); ?>
