		...
		<div class="contentpane">
			<div id="mailsterContainer">		
				<div id="mailsterUnsubscriber">
					<img src="<?php echo $mstAdminImgPath . '16-publish_x.png';?>" style="float:left;"/> 
					<div id="mailsterUnsubscriberDescription"><?php echo JText::_( 'COM_MAILSTER_UNSUBSCRIPTION_FAILED' ); ?></div>
				</div>
			</div>
		</div>
